...
import com.jdc.cafe.dao.ProductDao;
import com.jdc.cafe.service.ProductService;
            ...
            if (jwtFilter.isAdmin()){
                if (validateProductMap(requestMap,true)){
                   ...
                   if (!optional.isEmpty()){
                       ...
                       return CafeUtils.getResponseEntity("Product id doesn't exits ",HttpStatus.NOT_FOUND);
                   }
                } else {
                    return CafeUtils.getResponseEntity(CafeConstants.INVALID_DATA,HttpStatus.BAD_REQUEST);
                }
    ...
    public ResponseEntity<String> deleteProduct(Integer id) {
        try {
            if (jwtFilter.isAdmin()){
               ...
               return CafeUtils.getResponseEntity("Product Id doesn't exists.",HttpStatus.NOT_FOUND);
            }else {
                return CafeUtils.getResponseEntity(CafeConstants.UNAUTHORIZED_ACCESS,HttpStatus.UNAUTHORIZED);
            }
        }catch (Exception ex){
